...
%prep
%setup -q -n scp-0.13.5
cd %{_builddir}/scp-0.13.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625097759
...
cp %{_builddir}/scp-0.13.5/LICENSE.txt %{buildroot}/usr/share/package-licenses/scp/a393ab05655034ea1176ada5f33586112407ff71
